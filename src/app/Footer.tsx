...
export default function Footer({
    ...
    return (
        <footer
            className="mt-16 border-t bg-[var(--brand-dark)] text-white"
            style={{
                // variables CSS accessibles aux classes arbitraires Tailwind
                // ex: text-[var(--brand-primary)]
                // @ts-expect-error: CSS variables dynamiques
                "--brand-primary": brandPrimary,
                // @ts-expect-error
                "--brand-dark": brandDark,
                borderColor: "#ffffff1a", // blanc/10
            }}
        >
                        ...
                        {menus.map((m) => (
                            <li key={m.href + m.label}>
                                ...
                                >
                                    ...
                                    >
                                        <path d="M7 17l8-8M11 7h4v4" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                    </svg>
                                </Link>
                            </li>
                        ))}
                            ...
                            >
                                ...
                                <div className="flex items-start justify-between gap-3 p-3">
                                    <div>
                                        ...
                                        {latestPromo.date && (
                                            <p className="mt-1 text-xs text-zinc-500">{latestPromo.date}</p>
                                        )}
                                    </div>
                                    {/* badge FB */}
